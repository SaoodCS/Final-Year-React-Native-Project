...
// COMPONENT: DISPLAYS BOTH THE DEFAULT LEGS EXERCISES AND USER-CREATED LEGS EXERCISES IN ONE FLATLIST FOR THE USER TO ADD TO THE WORKOUT THEY ARE CREATING:
...
const Legs = ({route}, props) => {
  ...
  const legsExercises = filterOutRows(exercisesdb);
  ...
  const concatDefaultNSavedExercises = legsExercises.concat(changeLabels);
        ...
        <View
          ...
          <View
            ...
            <Text style={{fontSize: 20, color: 'black'}}>
              Add Legs Exercises For: {actualWorkoutName}
            </Text>
          </View>
        </View>
