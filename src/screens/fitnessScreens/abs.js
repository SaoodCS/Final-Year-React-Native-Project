...
// COMPONENT: DISPLAYS BOTH THE DEFAULT ABS EXERCISES AND USER-CREATED ABS EXERCISES IN ONE FLATLIST FOR THE USER TO ADD TO THE WORKOUT THEY ARE CREATING:
        ...
        <View
          ...
          <View
            ...
            <Text style={{fontSize: 20, color: 'black'}}>
              Add Abs Exercises For: {actualWorkoutName}
            </Text>
          </View>
        </View>
