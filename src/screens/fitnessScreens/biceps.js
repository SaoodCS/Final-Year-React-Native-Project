...
// COMPONENT: DISPLAYS BOTH THE DEFAULT BICEPS EXERCISES AND USER-CREATED BICEPS EXERCISES IN ONE FLATLIST FOR THE USER TO ADD TO THE WORKOUT THEY ARE CREATING:
        ...
        <View
          ...
          <View
            ...
            <Text style={{fontSize: 20, color: 'black'}}>
              Add Bicep Exercises For: {actualWorkoutName}
            </Text>
          </View>
        </View>
