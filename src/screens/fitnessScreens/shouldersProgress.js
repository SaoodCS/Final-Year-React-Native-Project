...
// COMPONENT: DISPLAYS BOTH THE DEFAULT SHOUDLERS EXERCISES AND USER-CREATED SHOULDERS EXERCISES IN ONE FLATLIST FOR THE USER TO PRESS ON AND VIEW THEIR PROGRESS ON THE DISPLAYEXPROGRESS COMPONENT

// DB TO GET AND DISPLAY USER CREATED EXERCISES
var db = openDatabase({name: 'userExercises.db'});

const ShouldersProgress = ({route}, props) => {
    ...
    <View style={{backgroundColor: '#171717', height: 700}}>
      <ScrollView>
        <CustomHeaderWithBack
          pageName="Shoulder Exercises Progress"
