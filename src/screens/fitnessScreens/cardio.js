...
// COMPONENT: DISPLAYS BOTH THE DEFAULT CARDIO EXERCISES AND USER-CREATED CARDIO EXERCISES IN ONE FLATLIST FOR THE USER TO ADD TO THE WORKOUT THEY ARE CREATING:
        ...
        <View
          ...
          <View
            ...
            <Text style={{fontSize: 20, color: 'black'}}>
              Add Cardio Exercises For: {actualWorkoutName}
            </Text>
          </View>
        </View>
