...
// COMPONENT: DISPLAYS BOTH THE DEFAULT BACK EXERCISES AND USER-CREATED BACK EXERCISES IN ONE FLATLIST FOR THE USER TO ADD TO THE WORKOUT THEY ARE CREATING:
      ...
      tx.executeSql(
        ...
        (tx, results) => {
          ...
          if (results.rowsAffected > 0) {
            console.log('Exercise Has Been Added To The Workout');
        ...
        <View
          ...
          <View
            ...
            <Text style={{fontSize: 20, color: 'black'}}>
              Add Back Exercises For: {actualWorkoutName}
            </Text>
          </View>
        </View>
