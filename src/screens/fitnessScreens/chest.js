...
// COMPONENT: DISPLAYS BOTH THE DEFAULT CHEST EXERCISES AND USER-CREATED CHEST EXERCISES IN ONE FLATLIST FOR THE USER TO ADD TO THE WORKOUT THEY ARE CREATING:
...
const Chest = ({route}, props) => {
  ...
  function filterOutRows(database) {
    ...
    //const stringified = JSON.stringify(result7);
    return result7;
  }
        ...
        <View
          ...
          <View
            ...
            <Text style={{fontSize: 20, color: 'black'}}>
              Add Chest Exercises For: {actualWorkoutName}
            </Text>
          </View>
        </View>
